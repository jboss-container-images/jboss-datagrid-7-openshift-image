...
GIT_REPO = "https://github.com/jboss-container-images/jboss-datagrid-7-openshift-image.git"
REPO_NAME = "jboss-datagrid-7-openshift-image/"
TEMPLATE_DOCS = "docs"
APPLICATION_DIRECTORIES = ("datagrid")
...
def createTemplate(data, path):
    ...
    with open('./docs/datagrid.adoc.in','r') as tmp:
